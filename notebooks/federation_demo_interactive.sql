...
CREATE SCHEMA IF NOT EXISTS ${analysis_catalog}.${db_prefix};
...
SELECT * FROM ${analysis_catalog}.${db_prefix}.machine_health_summary
...
SELECT * FROM ${analysis_catalog}.${db_prefix}.factory_operations_union
ORDER BY machine_id;
